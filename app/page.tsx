...
const faqCategories: HomeFaqCategory[] = [
  {
    ...
    title: "롤 대리 이용 전 확인",
    description:
      "진행 방식부터 승리·점수 보장제까지, 계정을 맡기기 전에 필요한 내용을 모았습니다.",
    detailHref: "/boosting",
  ...
  },
  {
    ...
    title: "견적부터 완료까지",
    description:
      "상담과 가격 산정, 기사 교체와 환불처럼 진행 전후에 자주 생기는 질문입니다.",
    detailHref: "#payment",
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "현재 티어, 진행 구간과 신청 수량, 라인·챔피언 요청, 기사 지정 여부 등에 따라 달라질 수 있습니다. 화면의 견적 계산기는 예상 금액이며 실제 금액은 상담 후 확정됩니다.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "결제는 알리페이로만 가능하며, 네이버페이·카카오페이를 통해서도 알리페이 결제를 이용하실 수 있습니다. 결제 방법은 기존과 동일합니다. 상담에서 전달받은 알리페이플러스(Alipay+) QR을 카카오페이 또는 네이버페이 앱으로 촬영해 결제해 주세요. 결제 전 화면에 표시된 금액과 수취 정보를 확인하고, 반드시 상담에서 받은 최신 QR을 사용해 주세요.",
      },
      {
