...
export default function PriceTable({ variant }: PriceTableProps) {
  ...
  const { hourly } = pricing;
  const score = variant === "boosting" ? boostingPrices.score : null;
  const lowTierWin = variant === "boosting" ? boostingPrices.lowTierWin : null;
