    ...
    <div className="mx-auto max-w-3xl">
      ...
      {categories.map((category) => {
        ...
        return (
          ...
          >
            {/* 카테고리 소개 (중앙, 키워드 h3 + 설명 유지) */}
            <div className="text-center">
              <h3 className="text-xl font-black tracking-tighter text-balance text-white sm:text-2xl">
                {category.title}
              </h3>
              <p className="mx-auto mt-3 max-w-xl text-sm leading-7 text-pretty text-zinc-400">
