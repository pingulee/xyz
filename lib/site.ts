...
export const lineups: Lineup[] = [
  {
    ...
    weekendHours: "ALL",
    specialties: ["성장 위주", "솔로 캐리", "오브젝트 운영"],
  ...
  },
  {
    ...
    tier: "/images/tier/10-challenger.png",
    description: "멘트",
    weekdayHours: "14:00 ~ 04:00",
    weekendHours: "12:00 ~ 04:00",
    specialties: ["시야 장악", "바텀 우선권", "교전 세팅"],
    champions: ["징크스"],
    services: ["대리", "듀오"],
  ...
  },
  {
    ...
    specialties: ["사이드 운영", "분열 압박", "탱커/캐리 모두 가능"],
    champions: ["다리우스", "제이스", "그웬"],
    services: ["대리"],
  ...
  },
  {
    ...
    specialties: ["갱킹", "빠른 클리어", "압박형 진행"],
    champions: ["헤카림", "비에고", "킨드레드"],
    services: ["대리", "듀오"],
    image: "/images/lineup-3.png",
  },
  {
    ...
    tier: "/images/tier/10-challenger.png",
    description:
      "암살자 및 컨트롤 마법사 챔피언에 풍부한 경험을 보유하고 있습니다.",
    weekdayHours: "13:00 ~ 03:00",
    weekendHours: "12:00 ~ 04:00",
    specialties: ["암살자 전문", "컨트롤 마법사", "솔로 킬"],
    champions: ["제드", "탈리야", "빅토르"],
    services: ["대리", "듀오"],
    image: "/images/lineup-1.png",
  },
  {
    ...
    tier: "/images/tier/10-challenger.png",
    description:
      "하이퍼 캐리 챔피언 운영과 후반 팀파이트 기여도가 높은 기사입니다.",
    weekdayHours: "15:00 ~ 05:00",
    weekendHours: "13:00 ~ 05:00",
    specialties: ["하이퍼 캐리", "팀파이트", "후반 운영"],
    champions: ["바루스", "트위치", "카이사"],
    services: ["대리", "듀오"],
    image: "/images/lineup-2.png",
  },
  {
    ...
    tier: "/images/tier/10-challenger.png",
    description:
      "인게이지 타이밍과 보호 서포터 모두 가능한 올라운드 기사입니다.",
    weekdayHours: "11:00 ~ 01:00",
    weekendHours: "10:00 ~ 02:00",
    specialties: ["인게이지", "보호 서포터", "오브젝트 세팅"],
    champions: ["알리스타", "소라카", "세나"],
    services: ["대리", "듀오"],
    image: "/images/lineup-3.png",
  },
  {
    ...
    specialties: ["탱커 전문", "합류 타이밍", "안정 진행"],
  ...
  },
  {
    ...
    specialties: ["텔레포트 연계", "글로벌 합류", "라인 안정"],
  ...
  },
  {
    ...
    specialties: ["초반 라인전", "타워 압박", "공격적 스타일"],
  ...
  },
  {
    ...
    weekdayHours: "12:00 ~ 02:00",
    weekendHours: "11:00 ~ 03:00",
    specialties: ["로밍 서포터", "카운터 픽", "시야 관리"],
  ...
  },
  {
    ...
    weekdayHours: "10:00 ~ 00:00",
    weekendHours: "10:00 ~ 02:00",
    specialties: ["스플릿 푸쉬", "1대1 교전", "솔로 캐리"],
  ...
  },
  {
    ...
    specialties: ["라인 푸쉬", "로밍 밸런스", "진행 안내"],
  ...
  },
  {
    ...
    specialties: ["유틸 원딜", "딜탱 챔피언", "후반 캐리"],
